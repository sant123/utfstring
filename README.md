...
UTF-safe string operations for Deno.

This is a fork from https://github.com/camertron/utfstring to make it work with Deno.
...
Tests are written in Deno.test and can be executed via [deno test](https://deno.land/manual/testing):

1. `deno test`

## Authors

Written by Cameron C. Dutro ([@camertron](https://github.com/camertron)) and maintained by Santiago Aguilar ([@sant123](https://github.com/sant123))

## License

Copyright 2020 Santiago Aguilar, licensed under the MIT license.
